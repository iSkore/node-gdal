...
int WarpOptions::parse(Local<Value> value)
{
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("options").ToLocalChecked()).FromJust() && additional_options.parse(obj->Get(Nan::New("options").ToLocalChecked()))){
		return 1; // error parsing string list
	}

	options->papszWarpOptions = additional_options.get();

	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("memoryLimit").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("resampling").ToLocalChecked()).FromJust()){
		prop = obj->Get(Nan::New("resampling").ToLocalChecked());
		if(parseResamplingAlg(prop)){
			return 1; //error parsing resampling algorithm
		}
	}
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("src").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("dst").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("srcBands").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("dstBands").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("srcNodata").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("dstNodata").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("srcAlphaBand").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("dstAlphaBand").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("blend").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("cutline").ToLocalChecked()).FromJust()){
	...
	if(obj->HasOwnProperty(Nan::GetCurrentContext(), Nan::New("multi").ToLocalChecked()).FromJust()){
